                    ...
                    <View style={styles.userDetailContainer} >
                        <TouchableOpacity style={styles.locationSelectContainer}>
                            <View style={styles.locationIconContainer} >
                                <Icon type='entypo' size={responsiveFontSize(4)} color={Colors.white} name='location-pin' />
                            </View>
                            <View>
                                <View style={styles.locationSelectContainer}>
                                    ...
                                    <Icon type='ant-design' size={responsiveFontSize(2)} color={Colors.white} name='caretdown' />
                                </View>

            ...
            <TouchableOpacity style={styles.container} onPress={() => navigation.navigate(RouteNames.storeDetailScreen)}>
                ...
                <View style={styles.detailsContainer} >
                    ...
                    <View style={styles.priceContainer} >
                        <Icon type='entypo' name='location-pin' color={Colors.grey} size={responsiveFontSize(2)} />
                        <Text style={styles.seeAllText}>
                            Street 36, Guild Wall London, UK
                        </Text>
                    </View>
                    <View style={styles.priceContainer} >
                        <Icon type='material-community' name='clock-time-four-outline' color={Colors.grey} size={responsiveFontSize(2)} />
                        <Text style={styles.seeAllText}>
                            5PM - 8AM | Open Now
                        </Text>
                    </View>
